...
/// Renamed glyph subset of Source Han Sans CN, generated by
/// `scripts/subset_font.py`.
pub const UI_FONT: &[u8] = include_bytes!("../../../assets/fonts/SmithSphereSans-Regular.otf");
const UI_FONT_NAME: &str = "SmithSphereSans";
